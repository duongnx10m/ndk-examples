...
import com.duongnx.ndk.examples.BuildConfig;
import com.duongnx.ndk.examples.Defines;
import com.duongnx.ndk.examples.R;

public class NativeAudioActivity extends BaseActivity
        implements ActivityCompat.OnRequestPermissionsResultCallback {


    //static final String TAG = "NativeAudioActivity";
        ...
        if (Build.VERSION.SDK_INT <= 19) {
            ...
            ((Button) findViewById(R.id.channels_uri)).setOnClickListener(new OnClickListener() {
                public void onClick(View view) {
                    ...
                    Toast.makeText(NativeAudioActivity.this, "Channels: " + numChannelsUri,
