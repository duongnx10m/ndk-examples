...
import com.duongnx.nativemedia.MyGLSurfaceView;
...
public class NativeMediaActivity extends BaseActivity {
    static final String TAG = "NativeMediaActivity";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.activity_native_media);
        setTitle(Defines.NATIVE_MEDIA);
