...
#define HELPER_CLASS_NAME \
  "com/duongnx/choreographer/NDKHelper"  // Class name of helper function
...
Java_com_duongnx_choreographer_ChoreographerNativeActivity_choregrapherCallback(
...
void Engine::DrawFrame() {
    ...
    float color[2][3] = {{1.0f, 0.5f, 0.5f},
                         {1.0f, 0.0f, 0.0f}};
