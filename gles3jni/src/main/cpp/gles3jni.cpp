...
extern "C" {
    JNIEXPORT void JNICALL Java_com_duongnx_gles3jni_GLES3JNIView_init(JNIEnv* env, jobject obj);
    JNIEXPORT void JNICALL Java_com_duongnx_gles3jni_GLES3JNIView_resize(JNIEnv* env, jobject obj, jint width, jint height);
    JNIEXPORT void JNICALL Java_com_duongnx_gles3jni_GLES3JNIView_step(JNIEnv* env, jobject obj);
};
...
Java_com_duongnx_gles3jni_GLES3JNIView_init(JNIEnv* env, jobject obj) {
    if (g_renderer) {
        delete g_renderer;
        g_renderer = NULL;
    }
...
JNIEXPORT void JNICALL
Java_com_duongnx_gles3jni_GLES3JNIView_resize(JNIEnv* env, jobject obj, jint width, jint height) {
    if (g_renderer) {
...
JNIEXPORT void JNICALL
Java_com_duongnx_gles3jni_GLES3JNIView_step(JNIEnv* env, jobject obj) {
    if (g_renderer) {
        g_renderer->render();
    }
}
