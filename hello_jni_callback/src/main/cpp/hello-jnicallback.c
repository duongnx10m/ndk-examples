...
Java_com_duongnx_ndk_examples_activities_JniCallbackActivity_stringFromJNI(JNIEnv *env,
                                                                           jobject thiz) {
#if defined(__arm__)
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    jclass clz = (*env)->FindClass(env,
                                   "com/duongnx/hellojni_callback/JniHandler");
...
Java_com_duongnx_ndk_examples_activities_JniCallbackActivity_startTicks(JNIEnv *env,
                                                                        jobject instance) {
 ...
 */
JNIEXPORT void JNICALL
Java_com_duongnx_ndk_examples_activities_JniCallbackActivity_StopTicks(JNIEnv *env,
                                                                       jobject instance) {
