...
void Java_com_duongnx_ndk_examples_activities_NativeMediaActivity_createEngine(JNIEnv *env,
                                                                               jclass clazz) {
    XAresult res;
...
jboolean Java_com_duongnx_ndk_examples_activities_NativeMediaActivity_createStreamingMediaPlayer(
        JNIEnv *env,
...
void Java_com_duongnx_ndk_examples_activities_NativeMediaActivity_setPlayingStreamingMediaPlayer(
        JNIEnv *env,
...
void Java_com_duongnx_ndk_examples_activities_NativeMediaActivity_shutdown(JNIEnv *env,
                                                                           jclass clazz) {
...
// set the surface
void Java_com_duongnx_ndk_examples_activities_NativeMediaActivity_setSurface(JNIEnv *env,
                                                                             jclass clazz,
                                                                             jobject surface) {
...
void Java_com_duongnx_ndk_examples_activities_NativeMediaActivity_rewindStreamingMediaPlayer(
