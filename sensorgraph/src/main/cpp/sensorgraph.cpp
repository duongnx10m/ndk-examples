...
Java_com_duongnx_ndk_examples_activities_AccelerometerGraphActivity_init(
...
JNIEXPORT void JNICALL
Java_com_duongnx_ndk_examples_activities_AccelerometerGraphActivity_surfaceCreated(JNIEnv *env,
                                                                                   jclass type) {
    (void) env;
    (void) type;
...
JNIEXPORT void JNICALL
Java_com_duongnx_ndk_examples_activities_AccelerometerGraphActivity_surfaceChanged(
...
JNIEXPORT void JNICALL
Java_com_duongnx_ndk_examples_activities_AccelerometerGraphActivity_drawFrame(
...
JNIEXPORT void JNICALL
Java_com_duongnx_ndk_examples_activities_AccelerometerGraphActivity_pause(
        JNIEnv *env, jclass type) {
    (void) env;
    (void) type;
    gSensorGraph.pause();
...
JNIEXPORT void JNICALL
Java_com_duongnx_ndk_examples_activities_AccelerometerGraphActivity_resume(
        JNIEnv *env, jclass type) {
    (void) env;
    (void) type;
    gSensorGraph.resume();
